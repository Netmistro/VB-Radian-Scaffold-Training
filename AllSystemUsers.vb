...
Public Class AllSystemUsers
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Radian_Training_Database.AllSystemUsers.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAllSystemUsers
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AllSystemUsers = New AllSystemUsers()
        rpt.Site = Me.Site
        Return rpt
    End Function
