...
Public Class frmForeignCompany
    ...
    Private Sub FrmForeignCompany_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            MySqlConn.Open()
            Dim Query As String
            Query = "select idfCompany as 'ID', CompanyName, ManDirector, Phone1 as 'Phone1', Phone2 as 'Phone2', Fax as 'Fax', Address as 'Address', City as 'City', MainContact, email , Website as 'Website'  from radiantraining.foreigncompany"
